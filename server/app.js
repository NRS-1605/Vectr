...
app.get("/schedwall/admin", (_req, res) => res.sendFile(path.join(__dirname, "..", "SchedWall", "views", "admin.html")));
app.get("/schedwall/wallpaper", (_req, res) => res.sendFile(path.join(__dirname, "..", "SchedWall", "views", "wallpaper.html")));
